...
export default function MemorySection() {
  ...
  return (
    <section className="py-24 bg-[#0a0a14] relative overflow-hidden border-t border-[#181830]">
      ...
      <div className="absolute left-0 bottom-0 w-[600px] h-[300px] bg-indigo-500/5 rounded-full blur-[130px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-4 rounded-xl bg-indigo-950/15 border border-indigo-500/20 text-xs text-slate-400 space-y-2">
            ...
            <div className="bg-[#0e0e1c] border border-[#202042] rounded-2xl p-6 shadow-2xl relative">
              ...
              <div className="flex items-center justify-between border-b border-[#202042] pb-4 mb-5">
                ...
                {memories.length < INITIAL_MEMORIES.length && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-[10px] font-mono font-semibold px-2.5 py-1 rounded bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 hover:bg-indigo-500/20 transition-all"
                  >
                    <RefreshCw size={10} />
                ...
                <AnimatePresence mode="popLayout">
                  {!personalizationEnabled ? (
                    ...
                    <motion.div
                      ...
                      className="h-[220px] flex flex-col items-center justify-center text-center p-4 border border-dashed border-[#202040] rounded-xl bg-[#090915]"
                    >
                      <Brain size={32} className="text-indigo-500/50 mb-2" />
                    ...
                    memories.map((mem) => (
                      ...
                      >
                        <div className="flex items-start gap-2.5">
                          ...
                          <div>
                            <span className="inline-block text-[9px] font-mono font-semibold px-1.5 py-0.5 rounded bg-indigo-500/10 text-indigo-300 border border-indigo-500/25 mb-1.5">
                              {mem.category}
                            </span>
              ...
              <div className="mt-5 pt-4 border-t border-[#202042] flex items-center justify-between text-[11px] text-slate-500">
                ...
                <button
                  ...
                  className="font-semibold text-indigo-400 hover:text-indigo-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Manage All Memories
                </button>
              </div>
